...
class UpdateSingleRequest extends FormRequest
{
     ...
     *
     * This assumes you have a 'single' route parameter bound to the Single model
     * and that your Single model has a 'user_id' attribute.
     * It checks if the currently authenticated user owns the single they are trying to update.
     */
