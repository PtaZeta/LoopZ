    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-gray-300 font-sans">
            <header className="fixed top-0 left-0 right-0 z-50 bg-black/80 backdrop-blur-md shadow-lg text-white">
                <div className="container mx-auto px-4 sm:px-6 py-3 flex items-center justify-between space-x-2 sm:space-x-4">
                    ...
                    <div className="hidden md:flex flex-grow justify-center items-center min-w-0 px-2">
                        <div className="relative w-full max-w-md lg:max-w-lg">
                            <input
                                ...
                                placeholder="Buscar Usuarios, Canciones, Contenedores..."
                    ...
                    <div className="flex-shrink-0 flex items-center space-x-2 md:space-x-3">
                        <nav className="hidden md:flex space-x-3 lg:space-x-4 items-center">
                            <Link href={route('biblioteca')} className="hover:text-blue-400 transition-colors text-sm">Biblioteca</Link>
                            <Link href={route('canciones.index')} className="hover:text-blue-400 transition-colors text-sm">Canciones</Link>
                            <Link href={route('playlists.index')} className="hover:text-blue-400 transition-colors text-sm">Playlists</Link>
                            <Link href={route('albumes.index')} className="hover:text-blue-400 transition-colors text-sm hidden lg:inline">Álbumes</Link>
                            <Link href={route('eps.index')} className="hover:text-blue-400 transition-colors text-sm hidden lg:inline">Eps</Link>
                            <Link href={route('singles.index')} className="hover:text-blue-400 transition-colors text-sm hidden lg:inline">Singles</Link>
                        </nav>
                        ...
                        {usuario ? (
                                    ...
                                    <Dropdown>
                                        <Dropdown.Trigger>
                                            <span className="inline-flex rounded-md">
                                                <button type="button" className="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-300 hover:text-blue-400 focus:outline-none transition ease-in-out duration-150">
                                                    {usuario.name}
                            ...
                            <div className="hidden sm:flex space-x-3 items-center">
                                ...
                                <Link href={route('register')} className="px-3 py-1.5 rounded-md text-sm font-medium bg-blue-600 hover:bg-blue-700 text-white transition-colors">Registrarse</Link>
                            </div>
                        )}
                ...
                <div className={`${showingMobileMenu ? 'block' : 'hidden'} md:hidden border-t border-gray-700/50`}>
                    <div className="p-3">
                        <input
                            type="search"
                            value={searchQuery}
                    ...
                    <div className="pt-2 pb-3 space-y-1 px-2">
                        <Link href={route('biblioteca')} className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700/50">Biblioteca</Link>
                        <Link href={route('canciones.index')} className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700/50">Canciones</Link>
                        <Link href={route('playlists.index')} className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700/50">Playlists</Link>
                        <Link href={route('albumes.index')} className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700/50">Álbumes</Link>
                        <Link href={route('eps.index')} className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700/50">Eps</Link>
                        <Link href={route('singles.index')} className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700/50">Singles</Link>
                    </div>
                    {usuario ? (
                        <div className="pt-4 pb-1 border-t border-gray-700/50">
                            <div className="px-5">
                            ...
                            <div className="mt-3 px-2 space-y-1">
                                <Link href={route('profile.edit')} className="block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700/50">Perfil</Link>
                                <Link href={route('logout')} method="post" as="button" className="w-full text-left block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700/50">Logout</Link>
                            </div>
                        </div>
                    ) : (
                        <div className="pt-4 pb-3 border-t border-gray-700/50 px-2 space-y-2">
                            <Link href={route('login')} className="block w-full text-left px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700/50">Iniciar Sesión</Link>
                            <Link href={route('register')} className="block w-full text-center px-3 py-2 rounded-md text-base font-medium bg-blue-600 hover:bg-blue-700 text-white transition-colors">Registrarse</Link>
                        </div>
                    )}
                </div>
            </header>
