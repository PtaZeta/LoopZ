...
export default function CrearLanzamiento({ auth }) {
    ...
    const { data, setData, post, processing, errors, progress, reset } = useForm({
        nombre: '',
        tipo: 'album', // Nuevo campo 'tipo' con valor predeterminado 'album'
        descripcion: '',
        imagen: null,
    ...
    const manejarEnvio = (e) => {
        ...
        post(route('lanzamiento.storeLanzamiento'), { // Ruta para almacenar lanzamientos
            forceFormData: true,
            preserveScroll: true,
            onSuccess: () => {
                reset();
                ...
                <div className="max-w-2xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-slate-800 overflow-hidden shadow-xl sm:rounded-lg">
                        <div className="p-6 md:p-8 text-gray-100">
                            <h3 className="text-lg font-medium text-gray-100 mb-6">Nuevo Lanzamiento</h3>
                            ...
                            <form onSubmit={manejarEnvio} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        className={`mt-1 block w-full sm:text-sm ${coreInputStyle} ${errors.tipo ? 'border-red-500' : ''}`}
                                        required
                                    >
                                ...
                                <div className="flex items-center justify-end space-x-4 pt-6 border-t border-slate-700 mt-6">
                                    ...
                                    >
                                        {processing ? 'Guardando...' : 'Guardar Lanzamiento'}
                                    </button>
                                </div>
