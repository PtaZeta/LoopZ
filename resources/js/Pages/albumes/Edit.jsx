...
export default function ContenedorEdit({ auth, contenedor, errors: erroresSesion, success: mensajeExitoSesion }) {
    ...
    const quitarUsuario = (usuarioId) => {
        ...
        if (usuarioAQuitar?.pivot?.propietario) {
             alert("No puedes quitar al propietario de la album.");
             return;
        }
    ...
    const manejarEnvio = (e) => {
        ...
        post(route('albumes.update', contenedor.id), {
            data: dataToSend,
            forceFormData: true,
            onSuccess: () => {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-200 leading-tight">Editar Album: {contenedor.nombre}</h2>}
        >
                ...
                <div className="max-w-2xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="bg-slate-800 overflow-hidden shadow-xl sm:rounded-lg">
                        <div className="p-6 md:p-8 text-gray-100">
                            <h3 className="text-lg font-medium text-gray-100 mb-4">Editando Album</h3>
