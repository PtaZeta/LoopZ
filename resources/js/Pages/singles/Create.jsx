...
export default function CrearSingle({ auth }) {
    ...
    const quitarUsuario = (usuarioId) => {
        if (auth.user?.id === usuarioId) {
            alert("No puedes quitar al creador de la single.");
            return;
        }
    ...
    const manejarEnvio = (e) => {
        ...
        post(route('singles.store'), {
             ...
             onError: (err) => {
                  console.error("Error al crear single:", err);
             },
        });
    };
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-200 leading-tight">Crear Nueva Single</h2>}
        >
                ...
                <div className="max-w-2xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-slate-800 overflow-hidden shadow-xl sm:rounded-lg">
                        <div className="p-6 md:p-8 text-gray-100">
                            <h3 className="text-lg font-medium text-gray-100 mb-6">Nueva Single</h3>
                            ...
                            <form onSubmit={manejarEnvio} className="space-y-6">
                                ...
                                <div className="flex items-center justify-end space-x-4 pt-6 border-t border-slate-700 mt-6">
                                    ...
                                    >
                                        {processing ? 'Guardando...' : 'Guardar Single'}
                                    </button>
                                </div>
