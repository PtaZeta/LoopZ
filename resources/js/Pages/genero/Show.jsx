...
export default function PlaylistComunidad({ auth, genero, playlists, usuariosDelGenero }) {
    ...
    const mostrarTodoPlaylists = () => setLimitePlaylists(12);
    const mostrarMasPlaylists = () => setLimitePlaylists((prev) => prev + 4);

    const mostrarTodoUsuarios = () => setLimiteUsuarios(12);
                ...
                <section id="playlists" className="container mx-auto px-6 py-10">
                    ...
                    {playlists.length > limitePlaylists && (
                        <div className="text-center mt-6">
                            <button onClick={mostrarMasPlaylists} className="text-blue-400 hover:text-blue-500">Mostrar Más</button>
                        </div>
                    )}
                </section>
                ...
                {usuariosDelGenero && usuariosDelGenero.length > 0 && (
                    <section id="usuarios" className="container mx-auto px-6 py-10">
                        ...
                        {usuariosDelGenero.length > limiteUsuarios && (
                            <div className="text-center mt-6">
                                <button onClick={mostrarMasUsuarios} className="text-blue-400 hover:text-blue-500">Mostrar Más</button>
                            </div>
                        )}
                    </section>
                )}
