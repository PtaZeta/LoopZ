...
const obtenerUrlImagen = (item) => {
    ...
    if (item?.imagen) return `/storage/${item.imagen}`;
    return null;
};
...
export default function PlaylistShow({ auth, playlist: listaReproduccionInicial }) {
    ...
    }, [buscarCancionesApi, listaReproduccion?.id]);
    ...
    }, [pagina.props.playlist, listaReproduccionInicial, listaReproduccion]);
