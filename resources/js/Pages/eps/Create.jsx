...
export default function CrearEP({ auth }) {
    ...
    const quitarUsuario = (usuarioId) => {
        if (auth.user?.id === usuarioId) {
            alert("No puedes quitar al creador de la ep.");
            return;
        }
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-200 leading-tight">Crear Nueva EP</h2>}
        >
            <Head title="Crear EP" />
                ...
                <div className="max-w-2xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-slate-800 overflow-hidden shadow-xl sm:rounded-lg">
                        <div className="p-6 md:p-8 text-gray-100">
                            <h3 className="text-lg font-medium text-gray-100 mb-6">Nueva EP</h3>
