...
export default function Edit({ auth, ep, errors: erroresSesion, success: mensajeExitoSesion }) {
    ...
    const idsInicialesUsuarios = ep.usuarios?.map(u => u.id) || [];
    const usuariosSeleccionadosIniciales = ep.usuarios?.map(u => ({ id: u.id, name: u.name, email: u.email })) || [];
                                ...
                                <div>
                                    ...
                                    {ep.imagen && !data.eliminar_imagen && (
                                        <div className="mt-2 mb-4">
                                            ...
                                            <img src={`/storage/${ep.imagen}`} alt="Imagen actual del álbum" className="h-24 w-24 object-cover rounded border border-gray-200" />
                                        </div>
                                    )}
                                    <input
                                        type="file"
